    ...
    return (
        <div className='about-wrap'>
            ...
            <div className='about-second'>
                ...
                <Link to={`/shop/balcony`}><img src={balcony} alt="" /><p>Balcony</p></Link>
                <Link to={`/shop/bathroom`}><img src={bathroom} alt="" /><p>bathroom</p></Link>
                <Link to={`/shop/bedroom`}><img src={bedroom} alt="" /><p>bedroom</p></Link>
                </div>
            </div>
            <div className='about-third'>
                <h2>Seamless Delivery Across the World</h2>
                <h4>Enjoy swift and dependable delivery across the World, bringing your stylish furniture and decor right to your doorstep. We ensure a smooth and timely experience from our store to your home.</h4>
                <div className="about-third-delivery">
                    ...
                    <div className='delivery'>
                        ...
                        Our swift and reliable delivery service ensures your products reach you promptly across the World. Enjoy a seamless delivery process with timely updates and careful handling of your items from our store to your doorstep.</p>
